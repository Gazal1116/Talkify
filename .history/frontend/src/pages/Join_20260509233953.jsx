...
function Join() {
  ...
  const handleJoin = () => {
    ...
    // Use "existing" as a marker so Chat component knows to not send sessionId
    // This allows the backend to use the existing session for this room
    navigate(`/chat/${roomCode}/existing/${username}`);
  };
